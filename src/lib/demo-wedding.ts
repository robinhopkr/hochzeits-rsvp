...
export const DEMO_WEDDING_CONFIG: WeddingConfig = {
  ...
  heroImageUrl: '/images/demo/cover-couple.jpg',
  couplePhotos: [
    {
      id: 'demo-couple-cover',
      imageUrl: '/images/demo/cover-couple.jpg',
      altText: 'Brautpaar in einer Gartenanlage waehrend der Golden Hour',
      caption: 'Willkommensbild',
    },
    {
      id: 'demo-couple-portrait-1',
      imageUrl: '/images/demo/couple-portrait-1.jpg',
      altText: 'Brautpaar unter einem Schleier bei einem intimen Portrait',
      caption: 'Paarportrait im Garten',
    },
    {
      id: 'demo-couple-portrait-2',
      imageUrl: '/images/demo/couple-portrait-2.jpg',
      altText: 'Brautpaar beim Portrait mit Brautstrauss im weichen Tageslicht',
  ...
  sectionImages: [
    {
      ...
      imageUrl: '/images/demo/section-program.jpg',
      altText: 'Festlich gedeckter Hochzeitstisch bei Kerzenschein',
    },
    {
      id: 'demo-section-location',
      section: 'anfahrt',
      title: 'Location & Anreise',
      imageUrl: '/images/demo/section-location.jpg',
      altText: 'Romantische Hochzeitslocation mit klassischer Architektur und Garten',
    },
    {
      id: 'demo-section-dresscode',
      section: 'dresscode',
      title: 'Dresscode Inspiration',
      imageUrl: '/images/demo/section-dresscode.jpg',
      altText: 'Braut mit elegantem Bouquet in stilvollen Naturtoenen',
    },
    {
      id: 'demo-section-rsvp',
      section: 'rsvp',
      title: 'Antworten mit Stil',
      imageUrl: '/images/demo/section-rsvp.jpg',
      altText: 'Verlobungsringe auf einer Einladungskarte mit floralen Details',
    },
    {
      id: 'demo-section-faq',
      section: 'faq',
...
export const DEMO_GALLERY_PHOTOS: GalleryPhoto[] = [
  {
    ...
    publicUrl: '/images/demo/gallery-golden-hour.jpg',
  ...
  },
  {
    ...
    publicUrl: '/images/demo/gallery-dinner.jpg',
  ...
  },
  {
    ...
    publicUrl: '/images/demo/gallery-dance.jpg',
